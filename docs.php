...
<body class="nav-md">
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($_POST['btnDocs']))
                                            {
                                                $id = $_POST['btnDocs'];
                                                    ...
                                                    $query = mysqli_query($con, "select * from document, dr_details where dr_details.DocReqID = '$id' and document.DocID = dr_details.DocID");

                                                    while($row = mysqli_fetch_array($query))
                                                    {
                                                        $doc = $row['DocDescription'];

                                                        echo "<tr><td>$id</td> <td> $doc </td> 


                                                            <td>
                                                                <button type='button' class='btn btn-primary' name = 'btnPrint' data-toggle='modal' data-target='#haha' >Print</button>
                                                        </td>
 ...
 <form method= 'post' action='brgycertificate.php'>
  <div class="modal fade" id="haha" role="dialog">
